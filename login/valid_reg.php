                ...
                if($result){   
                    ...
                    if($stmt->execute()){
                        ...
                        $body="<p>Greetings from team GYANITH!!<br>
                                    ...
                                    GYANITH ‘18 is the second collaborated technical fest hosted by NIT Puducherry. It is a union of 4 departments, coming together to celebrate science and innovation. GYANITH literally translates to “inspiring”. Hence, we are here to inspire you and give you an unforgettable experience of learning, fun and creation. We invite you to join us in the second edition of GYANITH and get inspired.
